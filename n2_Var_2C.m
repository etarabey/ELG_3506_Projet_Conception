function plot_puissance_n2(n2_array)
...
for n2 = n2_array % On itère sur les valeurs de n2
n = [1.33,1.5,n2,3.5]; 
...
lambda_1 = 400; lambda_2 = 1400; step = 1; % On fait varier lambda entre 400 nm et 1400 nm (spectre solaire). 
...
P_Array(m) = P; % Calcul pour la puissance transmis à une valeur de n2. On itère par la suite sur d'autres valeurs. 
m = m+1; 
end
% Graphe les valeurs de la puissance transmis sur les valeurs de n2. 
figure; 
plot(n2_array,P_Array);
title('Graphe de la puissance transmise en fonction de n2');
xlabel('n2')
ylabel('Puissance tranmise (W)')
end

n2_array = 1:0.01:3.5; % Tableau avec valeurs multiples de n2. 

plot_puissance_n2(n2_array);
